...
set FEATURES=%FEATURES% -Dmbsa.lib.core.log=%MBSA_ROOT%\bin\logs\fwcore\mbsaj.core.log -Dmbsa.lib.core.log.parts=2 -Dmbsa.lib.core.log.maxsize=250 -Dmbsa.lib.core.log.maxcount=10 -Dmbsa.lib.core.log.enable=%LOG_ENABLED%
