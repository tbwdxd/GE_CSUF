...
..\lib\runtimes\%MBSA_TARGET_PLATFORM%\mbsae.core.exe mbsa.cmd=start core.plugins.dir=..\lib\runtimes\%MBSA_TARGET_PLATFORM%\plugins mbsa.log.file=.\logs\mbsa_start.log core.log.file=.\logs\core.log core.prs.file=.\configs\win32\mbsal.core.prs mbsa.gui.notify=false %LOG_CFG% %*
set RC=%ERRORLEVEL%
